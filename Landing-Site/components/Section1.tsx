  ...
  return (
    <div className="flex h-[54rem] w-full flex-row justify-center border-2 bg-[#c6c8e9] bg-opacity-[80%] border-[#645ba7] pt-12 ">
      ...
      <div className=" animate h-[48rem]  w-[56rem] pl-24 ">
        <div className="font-pt-20 neon flex flex-col  gap-y-3 pt-24 text-6xl uppercase tracking-widest text-shadow">
          <p className={orbitron.className}>Retail</p>
          <p className={orbitron.className}>Renaissance</p>
        </div>
      ...
      <div className=" flex items-center ml-10 h-[48rem] w-[40rem]">
        <div className="relative h-4/5 w-full rounded-xl overflow-hidden">
          <video
            ...
            muted
          >
            <source src="/trial19.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </div>
      </div>
